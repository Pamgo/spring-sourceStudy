...
public class TestController {
	...
	@GetMapping("retry")
	public String testRetryByException(@RequestParam("key")String key, @RequestParam("count") int count){
		AtomicInteger num = map.computeIfAbsent(key, k-> new AtomicInteger());
		// 对请求或者重试次数技术
