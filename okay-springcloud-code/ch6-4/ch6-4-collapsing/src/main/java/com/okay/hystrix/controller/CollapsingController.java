package com.okay.hystrix.controller;

import com.okay.hystrix.service.ICollapsingService;
...
public class CollapsingController {
    ...
    public String getAnimal() throws Exception {
        Future<Animal> future1 = collapsingService.collapsing(1);
        Future<Animal> future2 = collapsingService.collapsing(2);
